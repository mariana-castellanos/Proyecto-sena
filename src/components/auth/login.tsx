    ...
    <div className="flex min-h-screen w-full">
      <div className="relative z-10 flex items-center justify-center h-full w-full">
        <form onSubmit={handleLogin}>
          <div className="w-full max-w-md p-6 bg-[#C4A4F3] rounded-lg shadow-lg border border-black"> {/* Fondo lila más oscuro con borde negro */}
            <div className="space-y-6">
              <div className="space-y-2 text-center">
                <h1 className="text-3xl font-bold text-[#5D2C8C]">Iniciar sesión</h1> {/* Texto en lila más oscuro */}
                <p className="text-[#5D2C8C]"> {/* Texto lila más oscuro */}
                </p>
              </div>
              <div className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-[#8A2BE2] text-white hover:bg-[#8A2BE2]"> {/* Botón lila claro */}
                  Iniciar sesión
                </Button>
              ...
              <div className="mt-4 text-center text-sm text-[#5D2C8C]">
                ...
                <Link href="#" className="underline text-[#5D2C8C]" prefetch={false}>
                  Regístrate
                </Link>
              </div>
            </div>
